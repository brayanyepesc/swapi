...
export const AlbumHeader = ({ imgUrl, sectionTitle, description, btnTitle }: AlbumHeaderProps) => {
    const defaultDescription = "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur, voluptatum corrupti hic temporibus sapiente distinctio omnis vel fugit fugiat quibusdam, suscipit aspernatur perferendis beatae, libero dicta cumque quas eos ducimus."
        ...
        <section className="w-full h-96 p-4 bg-gray-200 place-content-center shadow-xl">
            <div className="grid grid-cols-2 gap-8">
                ...
                <div className="flex flex-col justify-center space-y-8 p-4">
                    ...
                    <p className="text-gray-500">{description ? description : defaultDescription}</p>
